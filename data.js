...
import { SiFlutter, SiFirebase, SiHtml5, SiCss3, SiJavascript, SiShopify, SiMicrosoftazure  } from "react-icons/si";
...
const projects = [
  {
    ...
    images: {
      background: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716738054/kmz-dashboard_e0u0um.png",
      image1: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716807396/browser-kmz-dash_ceesrn.png",
      image2: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1700772741/MockUp_Variant3_wkrk50.png",
      image3: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1700772739/MockUp_Variant1_w0dngf.png",
    },
    tech_stack: [
      { name: "ReactJS", icon: <FaReact fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "NodeJS", icon: <FaNodeJs fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "MongoDB", icon: <FaDatabase fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "Figma", icon: <FaFigma fontSize={40} className="h-9 hover:text-gray-900" /> },
    ],
    key_features:
  ...
  },
  {
    ...
    images: {
      background: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716740770/quiz-time-2_vrgpu3.png",
      image1: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1700772676/TestImg_p0tiuf.png",
      image2: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1701029416/quiz-anim-b_zl8w9f.gif",
      image3: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1701029331/quiz-anim-a_ceh3o7.gif",
    },
    tech_stack: [
      { name: "Flutter", icon: <SiFlutter fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "Firebase", icon: <SiFirebase fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "Figma", icon: <FaFigma fontSize={40} className="h-9 hover:text-gray-900" /> },
    ],
    key_features:
  ...
  },
  {
    ...
    images: {
      background: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716741303/maa-mockups_oe5iwc.png",
      image1: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716807398/browser-maa-site_qhujpu.png",
      image2: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1701029416/quiz-anim-b_zl8w9f.gif",
      image3: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1701029331/quiz-anim-a_ceh3o7.gif",
    },
    tech_stack: [
  ...
  },
  {
    ...
    tech_stack: [
      { name: "ReactJS", icon: <FaReact fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "NodeJS", icon: <FaNodeJs fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "Azure HealthBot", icon: <SiMicrosoftazure  fontSize={40} className="h-9 hover:text-gray-900" /> }, // Assuming an icon
    ],
    link: "https://github.com/Joachim-Wambua/MediChatApp",
    images: {
      background: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716741952/medichat-mockup_s43oap.png",
      image1: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716807395/browser-medichat-site_hze2zk.png",
      image2: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1701198822/MobileUI-MultipleDevices_l6irb2.png",
      image3: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1701198823/WebUI-MultipleDevices_fvbrkc.png",
    },
    key_features:
  ...
  },
  {
    ...
    category: "Web Development",
    tech_stack: [
      { name: "HTML", icon: <SiHtml5 fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "CSS", icon: <SiCss3 fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "JavaScript", icon: <SiJavascript fontSize={40} className="h-9 hover:text-gray-900" /> },
      { name: "Shopify Liquid", icon: <SiShopify fontSize={40} className="h-9 hover:text-gray-900" /> },
    ],
    project_overview:
    ...
    images: {
      background: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716750214/kmz-website_l2dol6.png",
      image1: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1716807398/browser-kmz-site_sofpej.png",
      image2: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1702060758/kmz-mockup-2_1_du3oar.png",
      image3: "https://res.cloudinary.com/dltjv8zbh/image/upload/v1702060728/kmz-mockup-3_kgqynw.png",
    },
  },
];
